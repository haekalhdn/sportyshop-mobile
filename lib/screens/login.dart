...
import 'package:sportyshop/screens/register.dart';
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () async {
                      ...
                      final response = await request.login("https://haekal-handrian-sportyshop.pbp.cs.ui.ac.id/auth/login/", {
                        'username': username,
                        'password': password,
                      });
                  ...
                  GestureDetector(
                    ...
                    child: Text('Belum punya akun? Daftar', style: TextStyle(color: Theme.of(context).colorScheme.primary)),
                  )
                ],
              ),
            ),
